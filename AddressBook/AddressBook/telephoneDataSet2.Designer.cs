...
namespace AddressBook.telephoneDataSet2TableAdapters {
    ...
    public partial class userinfoTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[userinfo] ([UserName], [PassWord]) VALUES (@UserName, @PassWor" +
                "d);\r\nSELECT UserID, UserName, PassWord FROM userinfo WHERE (UserID = SCOPE_IDENT" +
                "ITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[userinfo] SET [UserName] = @UserName, [PassWord] = @PassWord WHERE (([UserID] = @Original_UserID) AND ([UserName] = @Original_UserName) AND ([PassWord] = @Original_PassWord));
SELECT UserID, UserName, PassWord FROM userinfo WHERE (UserID = @UserID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT UserID, UserName, PassWord FROM dbo.userinfo";
        ...
        public virtual int Fill(telephoneDataSet2.userinfoDataTable dataTable) {
        ...
        public virtual telephoneDataSet2.userinfoDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            telephoneDataSet2.userinfoDataTable dataTable = new telephoneDataSet2.userinfoDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(telephoneDataSet2.userinfoDataTable dataTable) {
