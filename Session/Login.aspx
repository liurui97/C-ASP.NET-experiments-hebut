        ...
        <table>
            ...
            <tr>
                <td colspan="3" style="text-align:center">
                    <asp:Button ID="submit" runat="server" Text="登陆" OnClick="submit_Click" style="height: 27px" CssClass="btn_login" />
                </td>
            </tr>
            <tr>
                <asp:Label ID="label3" runat="server" >Session登陆举例</asp:Label>
            </tr>
        </table>
    </div>
    </form>
